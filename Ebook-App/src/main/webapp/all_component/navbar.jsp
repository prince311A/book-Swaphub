...
<div class="coontainer-fluid" style="height: 10px; background-color: #303f9f"></div>
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<div class="col-md-3">
	<a href="cart.jsp"class="btn btn-warning text-white"><i class="fa-solid fa-cart-plus "></i> Cart</a>
